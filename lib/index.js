 ...
 * Funds
 * @class
 * @classdesc  Instanciates a Funds object
 */
let Funds = function() {
  this.email = '';
  this.password = '';
...
/**
 * Funds.prototype.getLogin
 * @public
 * @param  {object} [body]
 * @return {object} Promise object
 */
Funds.prototype.getLogin = async function( body ) {
...
/**
 * Funds.prototype.getExample
 * @public
 * @param  {boolean} [request]
 * @param  {boolean} [response]
 * @return {object} Promise object
 */
 Funds.prototype.getExample = async function( request, response ) {
...
/**
 * Funds.prototype.getData
 * @public
 * @param  {string} [url]
 * @param  {string} [token]
 * @return {object} Promise object
 */
Funds.prototype.getData = async function( url, token ) {
    ...
    let url_fetch = url_base + url_path;
